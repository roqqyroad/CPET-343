...
add wave -noupdate /seven_seg_counter_tb/uut/clk
add wave -noupdate /seven_seg_counter_tb/uut/reset
add wave -noupdate /seven_seg_counter_tb/uut/enable
add wave -noupdate -radix States /seven_seg_counter_tb/uut/seven_seg_outp
add wave -noupdate /seven_seg_counter_tb/uut/sum
add wave -noupdate /seven_seg_counter_tb/uut/sum_sig
